...
![prevent off road trail image](/titee15017/CarND-Behavioral-Cloning-P3/blob/master/examples/off_road.jpg?raw=true "prevent off road trail image")
![recovering image](/titee15017/CarND-Behavioral-Cloning-P3/blob/master/examples/recovering.jpg?raw=true "recovering image")
...
![data before process](/titee15017/CarND-Behavioral-Cloning-P3/blob/master/examples/1.png?raw=true "data before process")
![data after process](/titee15017/CarND-Behavioral-Cloning-P3/blob/master/examples/2.png?raw=true "data after process")
